...
<div class="min-h-screen bg-gray-50 py-4 sm:py-8 px-3 sm:px-4">
	<div class="max-w-2xl mx-auto">
		<header class="mb-6 sm:mb-8 text-center">
			<h1 class="text-2xl sm:text-4xl font-bold text-gray-900 mb-2">Todo App</h1>
			<p class="text-sm sm:text-base text-gray-600">Organize your tasks and stay productive</p>
		</header>
